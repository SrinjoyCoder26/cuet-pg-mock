  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      <header className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-4 flex items-center justify-between shadow-lg">
        ...
        <button 
          onClick={onBack} 
          className="bg-white text-blue-600 px-4 py-2 rounded-lg text-sm font-bold hover:bg-gray-100 transition-all shadow-md flex items-center gap-2"
        >
          <ArrowLeft size={18} />
          Back to Home
        </button>
      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
          <div className="bg-white rounded-2xl p-6 text-center border-2 border-blue-500 shadow-lg">
          ...
          <div className="bg-white rounded-2xl p-6 text-center border-2 border-green-500 shadow-lg">
          ...
          <div className="bg-white rounded-2xl p-6 text-center border-2 border-red-500 shadow-lg">
          ...
          <div className="bg-white rounded-2xl p-6 text-center border-2 border-gray-400 shadow-lg">
          ...
          <div className="bg-white rounded-2xl p-6 text-center border-2 border-purple-500 shadow-lg">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200 mb-6">
            ...
            <ResponsiveContainer width="100%" height={200}>
              <LineChart data={trendData}>
                ...
                <Tooltip />
                <Line type="monotone" dataKey="cumulative" stroke="#8b5cf6" strokeWidth={2} dot={{ r: 2 }} />
              </LineChart>
            </ResponsiveContainer>
          </div>
        ...
        <div className="space-y-3">
          {questions.map((q, index) => {
            ...
            return (
              <div 
                key={q.id} 
                className={`bg-white rounded-xl border-l-4 p-4 shadow-md transition-all hover:shadow-lg ${
                  isUnanswered ? "border-gray-400" : isCorrect ? "border-green-500" : "border-red-500"
                }`}
              >
